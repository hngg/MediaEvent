...
********************************************/
/**
 *  @brief Function get_1bit()   read one bit
...
/**
 *  @brief Function get_bits()  read n bits, n<=32
 *  @param[in]     h     get_bit_context structrue
...
/**
 *  @brief Function parse_codenum() ָRefer to section 9 of H264 standard for index Columbus code analysis
 *  @param[in]     buf     
 *  @retval        code_num
 *  @pre  
 *  @post 
...
/**
 *  @brief Function parse_ue() ָIndex Columbus code analysis UE (), refer to section 9 of H264 standard
...
/**
 *  @brief Function parse_se() ָAnalysis of index Columbus code (SE), refer to section 9 of H264 standard
 *  @param[in]     buf       sps_pps parse buf     
 *  @retval        code_num
 *  @pre  
 *  @post 
...
/**
 *  @brief Function get_bit_context_free()  release
 ...
 *  @post 
 */
int vui_parameters_set(void *buf, vui_parameters_t *vui_ptr)
{
    int ret = 0;
    int SchedSelIdx = 0;
...
/**
 *  @brief Function sps_info_print() debug info
 *  @param[in]     sps_ptr      sps struct
 *  @retval        
 *  @pre  
 *  @post 
 */
/*SPS used to print debug info*/
...
/**
 *  @brief Function h264dec_picture_parameter_set()  h264 PPS infomation parser
 *  @param[in]     buf       buf ptr, need synchronization 00 00 00 01 X8 and insert
 *  @param[in]     pps_ptr   ppsָ pointer, save pps address
 *  @retval        0: success, -1 : failure
 *  @pre  
 *  @post 
 */
