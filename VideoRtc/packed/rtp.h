...
//for count length
typedef struct rtp_extend
{
    pjmedia_rtp_ext_hdr head;
    ext_element_hdr     element;
}rtp_extend;
...
unsigned int pjmedia_video_add_rtp_exten(void *rtp_buf, pj_uint8_t ext_id, pj_uint8_t type, int ext_len);
