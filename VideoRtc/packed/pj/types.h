...
/**
 * Maximum video payload size. 
 */
#ifndef PJMEDIA_MAX_VID_PAYLOAD_SIZE			
#  define PJMEDIA_MAX_VID_PAYLOAD_SIZE		970//(PJMEDIA_MAX_MTU - 80)  //1440 = 1420+12+8 = 12x12x10
#endif
...
#pragma pack(1)
struct pjmedia_fec_hdr
{
	pj_uint16_t SN;			/**< Base Number of FEC	    */
	pj_uint8_t n;			/**< data packet num	    */
	pj_uint8_t m;			/**< fec packet num	        */

	//params below must be 16bits, cause they store the result of GF MULTI
	pj_uint16_t len_fec;	/**< payload len fec        */
    pj_uint16_t pt_fec;		/**< payload type fec		*/ 
};
#pragma pack()

typedef struct pjmedia_fec_hdr pjmedia_fec_hdr;
