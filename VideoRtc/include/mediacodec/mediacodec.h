...
#define TAGCODEC "MediaCodecDecoder"
#define MediaCodec_LOGI(...) __android_log_print(ANDROID_LOG_INFO , TAGCODEC, __VA_ARGS__)
#define MediaCodec_LOGE(...) __android_log_print(ANDROID_LOG_ERROR , TAGCODEC, __VA_ARGS__)
